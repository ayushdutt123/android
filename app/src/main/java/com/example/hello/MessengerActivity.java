...
import com.example.hello.model.MessageModel;
...
public class MessengerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_sendmessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!mymessage.isEmpty()){
                    ...
                    Toast.makeText(MessengerActivity.this, "Don't click me without message", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //***********back button event*********
        ...
        //**********select all messages between sender+receiver and bind in Recyclerview
        ...
        FirebaseDatabase.getInstance().getReference().child("message").child(senderuid+receiveruid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(MessengerActivity.this, messages.size()+"", Toast.LENGTH_SHORT).show();
            }
